...
<body class="bg-gradient-to-br from-gray-100 to-white min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md p-8 bg-white rounded-2xl shadow-xl">
        <h2 class="text-3xl font-semibold text-center text-gray-800 mb-6">Registracija</h2>
        ...
        <p class="mt-4 text-sm text-center text-gray-600">
            Već imaš nalog?
            <a href="index.php?controller=user&action=login" class="text-blue-500 hover:underline">Prijavi se</a>
        </p>
    </div>
</body>
</html>
